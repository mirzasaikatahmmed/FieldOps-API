        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    JobTemplateId = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Jobs_AspNetUsers_AssignedTechnicianId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TemplateFields_JobTemplates_JobTemplateId",
                        column: x => x.JobTemplateId,
                        principalTable: "JobTemplates",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_JobResponses_Jobs_JobId",
                        column: x => x.JobId,
                        principalTable: "Jobs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_JobResponses_TemplateFields_TemplateFieldId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_JobResponses_JobId_TemplateFieldId",
                table: "JobResponses",
                columns: new[] { "JobId", "TemplateFieldId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_JobResponses_TemplateFieldId",
                table: "JobResponses",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Signatures_JobId",
                table: "Signatures",
                column: "JobId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_TemplateFields_JobTemplateId",
